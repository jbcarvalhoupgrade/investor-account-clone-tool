...
import com.credify.investor.act.domain.cloneable.CustomAllocationConfig;
...
@Slf4j
public class AllocationConfigProcessor extends FileInvestmentAccountBasedProcessor<CustomAllocationConfig> {
