...
import com.credify.investor.act.domain.cloneable.CustomAccountConfig;
...
@Slf4j
public class AccountConfigProcessor extends FileInvestmentAccountBasedProcessor<CustomAccountConfig> {
